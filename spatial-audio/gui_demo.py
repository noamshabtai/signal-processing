    ...
    def azimuth_gui(self):
        ...
        self.azimuth_sliders = [
            tk.Scale(
                ...
                from_=-self.system.spatial_audio.grid.azimuth_span,
                to=self.system.spatial_audio.grid.azimuth_span,
                resolution=self.system.spatial_audio.grid.azimuth_resolution,
    ...
    def elevation_gui(self):
        ...
        self.elevation_sliders = [
            tk.Scale(
                master=self.master,
                orient=tk.VERTICAL,
                from_=-self.system.spatial_audio.grid.elevation_span,
                to=self.system.spatial_audio.grid.elevation_span,
                resolution=self.system.spatial_audio.grid.elevation_resolution,
