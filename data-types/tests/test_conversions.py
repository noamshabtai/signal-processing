...
def test_float_dtype_to_complex_dtype():
    ...
    try:
        data_types.conversions.float_dtype_to_complex_dtype(np.int32)
...
def test_normal_data(kwargs_normal_data):
    ...
    A = data_types.conversions.normal_data(**kwargs)
...
def test_normal_data_file(kwargs_normal_data_file, tmp_path):
    ...
    data_types.conversions.normal_data_file(**kwargs)
...
def test_make_yaml_safe(kwargs_make_yaml_safe):
    ...
    assert data_types.conversions.make_yaml_safe(input_data) == expected_output
